...
export declare const getParseKeyFn: (isDocument: boolean, shouldLeanIncludeVirtuals: boolean, noMongoose: boolean, datesAsStrings: boolean) => (key: string, valOriginal: any) => string;
export declare const parseSchema: ({ schema: schemaOriginal, modelName, isDocument, header, footer, noMongoose, datesAsStrings, shouldLeanIncludeVirtuals }: {
    schema: any;
